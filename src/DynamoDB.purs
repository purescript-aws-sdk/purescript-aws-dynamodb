...
batchGetItem = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "batchGetItem"
...
batchWriteItem = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "batchWriteItem"
...
deleteItem = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "deleteItem"
...
describeTable = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "describeTable"
...
getItem = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "getItem"
...
listTables = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "listTables"
...
putItem = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "putItem"
...
query = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "query"
...
scan = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "scan"
...
updateItem = Request.request service method  where
    service = Request.ServiceName "DynamoDB"
    method = Request.MethodName "updateItem"
